...
<head>
  <title>fPaymentHistory - Well Worn Thirsty Mole</title>
  ...
  <div>
    ...
    <div class="f-payment-history-container">
      ...
      <header data-thq="thq-navbar" class="f-payment-history-navbar-interactive">
        ...
        <div data-thq="thq-navbar-btn-group" class="f-payment-history-btn-group1"></div>
        ...
        <div data-thq="thq-mobile-menu" class="f-payment-history-mobile-menu">
          <div data-thq="thq-mobile-menu-nav" data-role="Nav" class="f-payment-history-nav1">
            <div class="f-payment-history-container1">
              <img alt="image" src="https://presentation-website-assets.teleporthq.io/logos/logo.png" class="f-payment-history-image1" />
            ...
            <nav data-thq="thq-mobile-menu-nav-links" data-role="Nav" class="f-payment-history-nav2">
              <span class="f-payment-history-text">About</span>
              <span class="f-payment-history-text01">Features</span>
              <span class="f-payment-history-text02">Pricing</span>
              <span class="f-payment-history-text03">Team</span>
              <span class="f-payment-history-text04">Blog</span>
            </nav>
            <div class="f-payment-history-container2">
              <button class="f-payment-history-login button">Login</button>
              <button class="button">Register</button>
            </div>
          </div>
          <div class="f-payment-history-icon-group">
            <svg viewBox="0 0 950.8571428571428 1024" class="f-payment-history-icon04">
            ...
            </svg><svg viewBox="0 0 877.7142857142857 1024" class="f-payment-history-icon06">
            ...
            </svg><svg viewBox="0 0 602.2582857142856 1024" class="f-payment-history-icon08">
      ...
      <div class="f-payment-history-hero">
        <div class="f-payment-history-container3">
          <div class="f-payment-history-sidebar">
            <nav class="f-payment-history-nav3">
              <svg viewBox="0 0 1024 1024" class="f-payment-history-icon10">
                <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
              </svg>

...
<head>
  <title>gConcerns - Well Worn Thirsty Mole</title>
  ...
  <div>
    ...
    <div class="g-concerns-container">
        ...
        <div data-thq="thq-mobile-menu" class="g-concerns-mobile-menu">
          <div data-thq="thq-mobile-menu-nav" data-role="Nav" class="g-concerns-nav1">
            <div class="g-concerns-container1">
              <img alt="image" src="https://presentation-website-assets.teleporthq.io/logos/logo.png" class="g-concerns-image1" />
            ...
            <nav data-thq="thq-mobile-menu-nav-links" data-role="Nav" class="g-concerns-nav2">
              <span class="g-concerns-text">About</span>
              <span class="g-concerns-text01">Features</span>
              <span class="g-concerns-text02">Pricing</span>
              <span class="g-concerns-text03">Team</span>
              <span class="g-concerns-text04">Blog</span>
            </nav>
            <div class="g-concerns-container2">
              <button class="g-concerns-login button">Login</button>
              <button class="button">Register</button>
            </div>
          </div>
          <div class="g-concerns-icon-group">
            <svg viewBox="0 0 950.8571428571428 1024" class="g-concerns-icon04">
            ...
            </svg><svg viewBox="0 0 877.7142857142857 1024" class="g-concerns-icon06">
            ...
            </svg><svg viewBox="0 0 602.2582857142856 1024" class="g-concerns-icon08">
      ...
      <div class="g-concerns-hero">
        <div class="g-concerns-container3">
          <div class="g-concerns-sidebar">
            <nav class="g-concerns-nav3">
              <svg viewBox="0 0 1024 1024" class="g-concerns-icon10">
                <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
              </svg>
            ...
            <div class="g-concerns-profile">
              ...
              <div class="g-concerns-container4">
                <span id="name" class="g-concerns-text20">Name</span>
        ...
        <div class="g-concerns-container5">
          ...
          <div class="g-concerns-container6">

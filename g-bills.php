...
<head>
  <title>gBills - Well Worn Thirsty Mole</title>
  ...
  <div>
    ...
    <div class="g-bills-container">
      <header data-thq="thq-navbar" class="g-bills-navbar-interactive">
        <img alt="image" src="public/playground_assets/logo-200h.png" class="g-bills-image" />
        ...
        <div data-thq="thq-mobile-menu" class="g-bills-mobile-menu">
          <div data-thq="thq-mobile-menu-nav" data-role="Nav" class="g-bills-nav1">
            <div class="g-bills-container1">
              <img alt="image" src="https://presentation-website-assets.teleporthq.io/logos/logo.png" class="g-bills-image1" />
            ...
            <nav data-thq="thq-mobile-menu-nav-links" data-role="Nav" class="g-bills-nav2">
              <span class="g-bills-text">About</span>
              <span class="g-bills-text01">Features</span>
              <span class="g-bills-text02">Pricing</span>
              <span class="g-bills-text03">Team</span>
              <span class="g-bills-text04">Blog</span>
            </nav>
            <div class="g-bills-container2">
              <button class="g-bills-login button">Login</button>
              <button class="button">Register</button>
            </div>
          </div>
          <div class="g-bills-icon-group">
            <svg viewBox="0 0 950.8571428571428 1024" class="g-bills-icon04">
            ...
            </svg><svg viewBox="0 0 877.7142857142857 1024" class="g-bills-icon06">
            ...
            </svg><svg viewBox="0 0 602.2582857142856 1024" class="g-bills-icon08">
      ...
      <div class="g-bills-banner">
        ...
        <div class="g-bills-hero">
          <div class="g-bills-container3">
            <div class="g-bills-sidebar">
              <nav class="g-bills-nav3">
                <svg viewBox="0 0 1024 1024" class="g-bills-icon10">
                  <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
                </svg>

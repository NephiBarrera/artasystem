...
<head>
  <title>gBrowseView - Well Worn Thirsty Mole</title>
  ...
  <div>
    ...
    <div class="g-browse-view-container">
      <header data-thq="thq-navbar" class="g-browse-view-navbar-interactive">
        ...
        <div data-thq="thq-navbar-btn-group" class="g-browse-view-btn-group"></div>
        <div data-thq="thq-burger-menu" class="g-browse-view-burger-menu">
          <svg viewBox="0 0 1024 1024" class="g-browse-view-icon">
            <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
          </svg>
        </div>
        <div data-thq="thq-mobile-menu" class="g-browse-view-mobile-menu">
          <div data-thq="thq-mobile-menu-nav" data-role="Nav" class="g-browse-view-nav1">
            <div class="g-browse-view-container01">
              <img alt="image" src="https://presentation-website-assets.teleporthq.io/logos/logo.png" class="g-browse-view-image1" />
              <div data-thq="thq-close-menu" class="g-browse-view-menu-close">
                <svg viewBox="0 0 1024 1024" class="g-browse-view-icon02">
                  <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                </svg>
              </div>
            </div>
            <nav data-thq="thq-mobile-menu-nav-links" data-role="Nav" class="g-browse-view-nav2">
              <span class="g-browse-view-text">About</span>
              <span class="g-browse-view-text01">Features</span>
              <span class="g-browse-view-text02">Pricing</span>
              <span class="g-browse-view-text03">Team</span>
              <span class="g-browse-view-text04">Blog</span>
            </nav>
            <div class="g-browse-view-container02">
              <button class="g-browse-view-login button">Login</button>
              <button class="button">Register</button>
            </div>
          </div>
          <div class="g-browse-view-icon-group">
            <svg viewBox="0 0 950.8571428571428 1024" class="g-browse-view-icon04">
            ...
            </svg><svg viewBox="0 0 877.7142857142857 1024" class="g-browse-view-icon06">
            ...
            </svg><svg viewBox="0 0 602.2582857142856 1024" class="g-browse-view-icon08">
      ...
      <div class="g-browse-view-hero">
        <div class="g-browse-view-container03">
          <div class="g-browse-view-sidebar">
            <nav class="g-browse-view-nav3">
              <svg viewBox="0 0 1024 1024" class="g-browse-view-icon10">
                <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
              </svg>

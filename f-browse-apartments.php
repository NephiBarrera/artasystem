...
<head>
  <title>fBrowseApartments - Well Worn Thirsty Mole</title>
  ...
  <div>
    ...
    <div class="f-browse-apartments-container">
        ...
        <div data-thq="thq-mobile-menu" class="f-browse-apartments-mobile-menu">
          <div data-thq="thq-mobile-menu-nav" data-role="Nav" class="f-browse-apartments-nav1">
            <div class="f-browse-apartments-container1">
              <img alt="image" src="https://presentation-website-assets.teleporthq.io/logos/logo.png" class="f-browse-apartments-image1" />
            ...
            <nav data-thq="thq-mobile-menu-nav-links" data-role="Nav" class="f-browse-apartments-nav2">
              <span class="f-browse-apartments-text">About</span>
              <span class="f-browse-apartments-text01">Features</span>
              <span class="f-browse-apartments-text02">Pricing</span>
              <span class="f-browse-apartments-text03">Team</span>
              <span class="f-browse-apartments-text04">Blog</span>
            </nav>
            <div class="f-browse-apartments-container2">
              <button class="f-browse-apartments-login button">Login</button>
              <button class="button">Register</button>
            </div>
          </div>
          <div class="f-browse-apartments-icon-group">
            <svg viewBox="0 0 950.8571428571428 1024" class="f-browse-apartments-icon04">
            ...
            </svg><svg viewBox="0 0 877.7142857142857 1024" class="f-browse-apartments-icon06">
            ...
            </svg><svg viewBox="0 0 602.2582857142856 1024" class="f-browse-apartments-icon08">
      ...
      <div class="f-browse-apartments-hero">
        <div class="f-browse-apartments-container3">
          <div class="f-browse-apartments-sidebar">
            <nav class="f-browse-apartments-nav3">
              <svg viewBox="0 0 1024 1024" class="f-browse-apartments-icon10">
                <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
              </svg>

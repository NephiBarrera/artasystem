...
<head>
  <title>gInquiries - Well Worn Thirsty Mole</title>
  ...
  <div>
    ...
    <div class="g-inquiries-container">
        ...
        <div data-thq="thq-mobile-menu" class="g-inquiries-mobile-menu">
          <div data-thq="thq-mobile-menu-nav" data-role="Nav" class="g-inquiries-nav1">
            <div class="g-inquiries-container1">
              <img alt="image" src="https://presentation-website-assets.teleporthq.io/logos/logo.png" class="g-inquiries-image1" />
            ...
            <nav data-thq="thq-mobile-menu-nav-links" data-role="Nav" class="g-inquiries-nav2">
              <span class="g-inquiries-text">About</span>
              <span class="g-inquiries-text01">Features</span>
              <span class="g-inquiries-text02">Pricing</span>
              <span class="g-inquiries-text03">Team</span>
              <span class="g-inquiries-text04">Blog</span>
            </nav>
            <div class="g-inquiries-container2">
              <button class="g-inquiries-login button">Login</button>
              <button class="button">Register</button>
            </div>
          </div>
          <div class="g-inquiries-icon-group">
            <svg viewBox="0 0 950.8571428571428 1024" class="g-inquiries-icon04">
            ...
            </svg><svg viewBox="0 0 877.7142857142857 1024" class="g-inquiries-icon06">
            ...
            </svg><svg viewBox="0 0 602.2582857142856 1024" class="g-inquiries-icon08">
      ...
      <div class="g-inquiries-hero">
        <div class="g-inquiries-container3">
          <div class="g-inquiries-sidebar">
            <nav class="g-inquiries-nav3">
              <svg viewBox="0 0 1024 1024" class="g-inquiries-icon10">
                <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
              </svg>

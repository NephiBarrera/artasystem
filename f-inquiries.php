...
<head>
  <title>fInquiries - Well Worn Thirsty Mole</title>
  <meta property="og:title" content="fInquiries - Well Worn Thirsty Mole" />
...
<body>
  <div>
    <link href="./f-inquiries.css" rel="stylesheet" />
    ...
    <div class="f-inquiries-container">
        ...
        <div data-thq="thq-mobile-menu" class="f-inquiries-mobile-menu">
          <div data-thq="thq-mobile-menu-nav" data-role="Nav" class="f-inquiries-nav1">
            <div class="f-inquiries-container1">
              <img alt="image" src="https://presentation-website-assets.teleporthq.io/logos/logo.png" class="f-inquiries-image1" />
            ...
            <nav data-thq="thq-mobile-menu-nav-links" data-role="Nav" class="f-inquiries-nav2">
              <span class="f-inquiries-text">About</span>
              <span class="f-inquiries-text01">Features</span>
              <span class="f-inquiries-text02">Pricing</span>
              <span class="f-inquiries-text03">Team</span>
              <span class="f-inquiries-text04">Blog</span>
            </nav>
            <div class="f-inquiries-container2">
              <button class="f-inquiries-login button">Login</button>
              <button class="button">Register</button>
            </div>
          </div>
          <div class="f-inquiries-icon-group">
            <svg viewBox="0 0 950.8571428571428 1024" class="f-inquiries-icon04">
            ...
            </svg><svg viewBox="0 0 877.7142857142857 1024" class="f-inquiries-icon06">
            ...
            </svg><svg viewBox="0 0 602.2582857142856 1024" class="f-inquiries-icon08">
      ...
      <div class="f-inquiries-hero">
        <div class="f-inquiries-container3">
          <div class="f-inquiries-sidebar">
            <nav class="f-inquiries-nav3">
              <svg viewBox="0 0 1024 1024" class="f-inquiries-icon10">
                <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
              </svg>
              <span class="f-inquiries-text05"><a href="f-bills.php">BILLS</a></span>
              <span class="f-inquiries-text06"><a href="f-payment-history.php">PAYMENT HISTORY</a></span>
              <span class="f-inquiries-text07">
      ...
      <!-- <footer class="f-inquiries-footer">
        <span class="f-inquiries-text28">
          © 2022 Apartment Rental Tracking System
        </span>
        <div class="f-inquiries-icon-group1"></div>
      </footer> -->
      <div class="f-inquiries-btn-group1"></div>
    </div>
  </div>
...
<script type="module">
  ...
  get(child(dbRef, "user_log/email")).then((snapshot) => {
    if (snapshot.exists()) {
      ...
      function addItemsToList(em, duedate, unitno, rentfee, stat) {
